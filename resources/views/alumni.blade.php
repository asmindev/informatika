<x-layout>
    <section class="w-full md:w-10/12 lg:w-8/12 mx-auto px-4">
        ...
        <div class="py-12 grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-fr">
                    ...
                    <div class="w-full h-full flex flex-col justify-end p-4">
                        <div class="text-left">
                            <div class="flex justify-between">
                                ...
                                <h3 class="text-white text-sm">{{ $alumni->graduation_year }}</h3>
                            </div>
                            <h3 class="text-blue-400 text-sm">{{ $alumni->job_title }}</h3>
                        </div>
                    </div>
                </div>
            </div>
