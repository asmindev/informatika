    ...
    <section
        ...
        <div class="w-full h-full flex flex-col-reverse gap-y-12 md:flex-row items-stretch">
            ...
            <div class="w-full md:w-1/3 md:scale-110 h-full rounded-full overflow-hidden">
                <div
                    class="relative w-full h-full md:p-10 before:md:absolute before:bg-indigo-600/50 before:w-full before:h-full before:blur-xl after:absolute after:bg-red-600 after:w-full after:h-12 after:left-0 after:bottom-24 after:-z-10">
                    <div
                        class="relative w-full border-b border-orange-600 rounded-full overflow-hidden h-[22rem] before:absolute before:bg-indigo-500 before:bottom-0 before:w-full before:h-2/6 before:md:h-1/2 before:blur-xl">
                        <img src="{{ asset('assets/avatar.png') }}" alt="Avatar"
                            class="w-full md:h-full absolute bottom-0 object-cover">
                    </div>
                </div>
            </div>
        </div>
        <div class="relative z-50 mt-12 w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <a href="#" class="w-full block h-full bg-gradient-to-br from-pink-400 to-pink-600 rounded-3xl p-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-pink-400 rounded-full p-2 size-12 text-pink-200">
            ...
            <a href="https://ta.ti.eng.uho.ac.id" target="_blank"
                class="w-full h-full bg-gradient-to-br from-lime-400 to-lime-600 rounded-3xl p-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-lime-400 rounded-full p-2 size-12 text-lime-200">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="#" class="w-full h-full bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-3xl p-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-cyan-400 rounded-full p-2 size-12 text-cyan-200">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="#" class="w-full h-full bg-gradient-to-br from-violet-400 to-violet-600 rounded-3xl p-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-violet-400 rounded-full p-2 size-12 text-violet-200">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="https://ojs.uho.ac.id/index.php/semantik" target="_blank"
                class="w-full h-full bg-gradient-to-br from-orange-400 to-orange-600 rounded-3xl p-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-orange-400 rounded-full p-2 size-12 text-orange-200">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="https://animator.uho.ac.id" target="_blank"
                class="w-full h-full bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-3xl p-4">

                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="bg-emerald-400 rounded-full p-2 size-12 text-emerald-200">
                    <path stroke-linecap="round" stroke-linejoin="round"
