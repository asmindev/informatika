<x-layout>
    <section class="w-full md:w-11/12 lg:w-10/12 mx-auto px-4">
        <div class="mt-24 py-12 px-8 bg-blue-100 rounded-xl">
            <h1 class="text-3xl font-bold text-slate-800">Penelitian</h1>
            <p class="mt-2 text-slate-600">Penelitian Jurusan Teknik Informatika Universitas Halu Oleo</p>
        </div>
        <div class="w-full my-12 py-8 bg-slate-50 px-6 rounded-xl">
            ...
            <div class="w-full">
                ...
                <div class="ps-2 my-2 first:mt-0">
                    <h3 class="text-xs font-medium uppercase text-slate-500 dark:text-neutral-400 underline">
                        {{ $p["year"] }}
                    </h3>
                </div>
                <!-- End Heading -->
